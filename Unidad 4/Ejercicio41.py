# -*- coding: utf-8 -*- ython que permita agregar elementos o atributos, se deben utilizar métodos de clase y, comúnmente, listas o diccionarios para almacenar la información. 

class Alumno:
    #Agregar para inicializar un objeto al momento de crear una instancia de una clase.
...
# agrega una variable llamada carrera 
class Carrera:
    def __init__(self, nombre: str):
        self.nombre = nombre
...
#permita agregar elementos o atributos, se deben utilizar métodos de clase y, comúnmente, listas o diccionarios para almacenar la información. 
class Materia:
